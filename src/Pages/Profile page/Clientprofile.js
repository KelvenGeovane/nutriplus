    ...
    return (
        ...
        <div className="Profile">
            <div className="parent__container">
                ...
                <div className="Info">
                    <TextField id="username" name="name" onChange={handleChange} label="Usuário" value={data?.name} variant="outlined" />
                    <TextField id="Email" name="email" onChange={handleChange} label="Email" value={data?.email} variant="outlined" type="email" />
                    <TextField id="Password" label="Senha" value="12345" variant="outlined" type="password" />
                    <div className="numericals">
                        <TextField id="weight" name="weight" onChange={handleChange} label="Peso" value={data?.weight}
                            InputProps={{
                                endAdornment: <InputAdornment position="end">Kg</InputAdornment>,
                            }}
                            variant="outlined" />
                        <TextField id="height" name="height" onChange={handleChange} label="Altura" value={data?.height}
                            InputProps={{
                                endAdornment: <InputAdornment position="end">cm</InputAdornment>,
                            }}
                            variant="outlined" />
                        <TextField id="age" name="age" onChange={handleChange} label="Idade" value={data?.age}
                            InputProps={{
                                endAdornment: <InputAdornment position="end">Anos</InputAdornment>,
                            }}
                            variant="outlined" />
                    </div>
                    <TextField id="gender" name="gender" onChange={handleChange} label="Genero" value={data?.gender} variant="outlined" placeholder="Moderate" select>
                        <MenuItem value="0">Masculino</MenuItem>
                        <MenuItem value="1">Feminino</MenuItem>
                    </TextField>
                    <TextField id="Goal_select" name="goal" onChange={handleChange} label="Oque Procura ?" value={data?.goal} variant="outlined" placeholder="Maintain weight" select>
                        <MenuItem value="0">Manter Peso</MenuItem>
                        <MenuItem value="1">Perder Peso</MenuItem>
                        <MenuItem value="2">Ganhar Peso</MenuItem>
                    </TextField>
                    <TextField id="Activity_select" name="activity_level" onChange={handleChange} label="Atividades" value={data?.activity_level} variant="outlined" placeholder="Moderate" select>
                        <MenuItem value="0">Moderado</MenuItem>
                        <MenuItem value="1">Atividades Leves</MenuItem>
                        <MenuItem value="2">Atividades Altas</MenuItem>
                    </TextField>
                </div>
