...
function Recipes() {
    ...
    return (
        ...
        <div style={{width:'100vw'}}>
            ...
            paddingBottom:'5px',
            paddingTop:'15px',
        }}>Pesquise qualquer alimento para ver sua receita </p>
            ...
            <div className="Filterbox" >
                    <h3>Definir limite de calorias</h3>
                    <div className="filterInput">
                        <span id="input-min">
                            <TextField id="min-calories" name="Min" placeholder="Min" value={minCal} onChange= {(event)=>setminCal(event.target.value)} variant="outlined" helperText="Definir valor mínimo"/>
                        </span>
                        
                        <span id="input-max">
                            <TextField id="max-calories" name="Max" placeholder="Max" value={maxCal} onChange= {(event)=>setmaxCal(event.target.value)} variant="outlined" helperText="Definir valor máximo"/>
                        </span>
                    </div>

                    <h3>Definir limite de proteína</h3>
                    <div className="filterInput">
                        <span id="input-min-protein">
                            <TextField id="min-protein" name="MinProtein" placeholder="Min-Protein" value={minPro} onChange= {(event)=>setminPro(event.target.value)} variant="outlined" helperText="SDefinir valor mínimo"/>
                        </span>
                        
                        <span id="input-max">
                            <TextField id="max-protein" name="MaxProtein" placeholder="Max-Protein" value={maxPro} onChange= {(event)=>setmaxPro(event.target.value)} variant="outlined" helperText="Definir valor máximo"/>
                        </span>
                    </div>

                    <h3>Definir limite de gordura</h3>
                    <div className="filterInput">
                        <span id="input-min-protein">
                            <TextField id="min-protein" name="MinProtein" placeholder="Min-Fat" value={minFat} onChange= {(event)=>setminFat(event.target.value)} variant="outlined" helperText="Definir valor mínimo"/>
                        </span>
                        
                        <span id="input-max">
                            <TextField id="max-protein" name="MaxProtein" placeholder="Max-Fat" value={maxFat} onChange= {(event)=>setminFat(event.target.value)} variant="outlined" helperText="Definir valor máximo"/>
                        </span>
                    </div>

                    <h3>Definir limite de carboidratos</h3>
                    <div className="filterInput">
                        <span id="input-min-protein">
                            <TextField id="min-protein" name="MinProtein" placeholder="Min-Carbs" value={minCarb} onChange= {(event)=>setminCarb(event.target.value)} variant="outlined" helperText="Definir valor mínimo"/>
                        </span>
                        
                        <span id="input-max">
                            <TextField id="max-protein" name="MaxProtein" placeholder="Max-Carbs" value={maxCarb} onChange= {(event)=>setmaxCarb(event.target.value)} variant="outlined" helperText="Definir valor máximo"/>
                        </span>
                    </div>
            </div>
